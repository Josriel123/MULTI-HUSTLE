...
export const NOT_MODELED: readonly string[] = [
  ...
  'W-2 wages, tips, withholding, and estimated tax payments, unless supplied directly to the engine; bank deposits of paychecks are never treated as wages. Schedule SE lines 8b-8c (unreported tips, Form 4137; wages on Form 8919) are not modeled.',
