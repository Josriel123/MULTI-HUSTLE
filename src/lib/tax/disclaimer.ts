...
export const NOT_MODELED: readonly string[] = [
  ...
  'Refunds of deducted business expenses: a deposit categorized as a refund is excluded from income but does not reduce the expense it reverses (Pub. 525, "Recovery and expense in same year"). Reduce that expense yourself.',
