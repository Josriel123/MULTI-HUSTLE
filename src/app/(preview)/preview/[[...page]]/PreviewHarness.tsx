...
import EducationPage from '@/app/(app)/education/page';
import JobsPage from '@/app/(app)/jobs/page';
import MileagePage from '@/app/(app)/mileage/page';
import HomeOfficePage from '@/app/(app)/office/page';
...
import { AgreementScreen } from '@/components/legal/AgreementGate';
import { previewAgreement, previewData, previewResponse, type Scenario } from './fixtures';
...
const PAGES = {
  ...
  profile: ProfilePage,
  account: AccountPage,
  // The step before the app, as a first-time user sees it. Agreeing does nothing here.
  agreement: function AgreementPreview() {
    return <AgreementScreen status={previewAgreement(true)} onAccepted={() => {}} />;
  },
} as const;
