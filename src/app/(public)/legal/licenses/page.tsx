 ...
 * /third-party-notices.txt (public/, generated by `npm run notices`, which
 * carries the full license texts). Only what ships to users is listed; build
 * and test tools are not redistributed.
 */
const SOFTWARE = [
      ...
      sections={[
        {
          ...
          body: (
            <>
              ...
              <p>
                The full license text of every package, generated from what the app actually installs, is in the{' '}
                <a href="/third-party-notices.txt" className="font-medium text-accent underline underline-offset-2 hover:no-underline">
                  third-party notices file
                </a>
                , and in each project&rsquo;s repository.
              </p>
            </>
          ),
        },
